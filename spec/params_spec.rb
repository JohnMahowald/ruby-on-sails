...
describe RailsOnSails::Params do
  before(:all) do
  ...
  it "handles an empty request" do
    expect { RailsOnSails::Params.new(req) }.to_not raise_error
  end

  context "query string" do
    it "handles single key and value" do
      req.query_string = "key=val"
      params = RailsOnSails::Params.new(req)
  ...
  context "route params" do
    it "handles route params" do
      params = RailsOnSails::Params.new(req, {"id" => 5, "user_id" => 22})
      params["id"].should == 5
